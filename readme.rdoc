...
You can check if your .lock files are expired, by passing :expire_after argument into initializer
    ...
    l = LockFile.new({:expire_after => "1 hour"})
    l = LockFile.new({:expire_after => "5 hours"})
    l = LockFile.new({:expire_after => "1 minute"})
    l = LockFile.new({:expire_after => "100 minutes"})
    l = LockFile.new({:expire_after => "2 hours and 10 minutes"})
